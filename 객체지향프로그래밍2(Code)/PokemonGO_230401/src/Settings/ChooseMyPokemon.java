...
/* Settings.ChooseMyPokemon
게임을 함께할 Pokemon을 고르는 클래스
 */

public class ChooseMyPokemon {
    ...
    public static void setExp(int expNum) {
        exp = expNum;
    }
    ...
    public void StartTrip() {
        System.out.println("오박사 :  자네와 함께할 친구는 " + PoList.getPoList_level1().get(this.choice).getName() + "이다!");
        System.out.println("오박사 :  자! 즐거운 여행을 하고오거라!");
        setMyPoName(PoList.getPoList_level1().get(this.choice).getName());
        setMyPoPower(PoList.getPoList_level1().get(this.choice).getPower());
        setMyPoSpeed(PoList.getPoList_level1().get(this.choice).getSpeed());
        System.out.println("그렇게 " + OwnerSetting.getOwner() + "는(은) " + getMyPoName() + "와 함께 여행을 떠나게 되는데...!!!");
        System.out.println("☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★");
    }

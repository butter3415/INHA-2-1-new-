...
public class DBManager {
    ...
    void createPokemonDB(){
        try{
            ...
            stm.executeUpdate(
                    "CREATE TABLE `pokemonDataBase`(id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, name varchar(70), `power` INT, `speed` INT, `skill1` varchar(70),`skill2` varchar(70))");
        ...
        try{
            ...
            for (PokemonForDBSaveDetail pNS : pokemonList){
                ...
                stm.executeUpdate("INSERT INTO `pokemonDataBase` " +
                        "VALUES(0,'" + pNS.getName() + "', '" +  ranPower + "', '" + ranSpeed + "', '" + pNS.getSkill1() + "', '" + pNS.getSkill2() + "')");
